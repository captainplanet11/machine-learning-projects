...
__all__ = ['draw_tree', 'get_sample', 'add_datepart', 'is_date', 'train_cats', 'apply_cats', 'fix_missing',
           'numericalize', 'scale_vars', 'proc_df', 'rf_feat_importance','set_rf_samples','reset_rf_samples']
...
# Cell
def proc_df(df, y_fld,subset, skip_flds=None, ignore_flds=None, do_scale=False, na_dict=None,
